...
F2::
thread1 := DllCall("AutoHotkey\ahkdll", "str", "mandelbrot1.ahk", "str"
, "", "str", "parameter1", "Cdecl Int")
return


F3::
thread1 := DllCall("AutoHotkey2\ahkdll", "str", "mandelbrot2.ahk", "str"
, "", "str", "parameter1", "Cdecl Int")
return


F4::
thread1 := DllCall("AutoHotkey3\ahkdll", "str", "mandelbrot3.ahk", "str"
, "", "str", "parameter1", "Cdecl Int")
return
